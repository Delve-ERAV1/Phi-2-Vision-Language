...
class CLIPQuestionAnsweringModel(LightningModule):
    def __init__(self, phi_model_name, clip_embed=768, phi_embed=2560):
        ...
        self.projection = load_projection_model("temp/MModalGPT-FINETUNE-step=16100-loss=3.36.ckpt", clip_embed, phi_embed)
        ...
        self.peft_model = peft.PeftModel.from_pretrained(self.text_model, 'temp/16100', is_trainable=True)
